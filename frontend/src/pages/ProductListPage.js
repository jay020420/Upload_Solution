...
const ProductListPage = () => { // props 제거
  ...
  }, [dispatch, navigate, userInfo, currentPage, pageSize, sortField, sortOrder]); // 의존성 배열 업데이트
      ...
      <PageHeader
        ...
        extra={[
          ...
          <Button
            ...
            type="primary"
            icon={<PlusOutlined />}
            onClick={() => navigate('/admin/product/create')} // history.push 대신 navigate 사용
          >
            상품 등록
          </Button>
        ]}
